...
#pragma mark -
#pragma mark DirectoryViewController
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    Directory *newManagedObject = [self.fetchedResultsController objectAtIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    directoryDetailController.directory = selectedDirectory;
    
    [self.navigationController pushViewController:directoryDetailController animated:YES];
}
