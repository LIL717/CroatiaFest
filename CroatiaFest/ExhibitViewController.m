...
#pragma mark -
#pragma mark ExhibitViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExhibitDetailController *exhibitDetailController = [[[ExhibitDetailController alloc] initWithNibName:@"EventTypeDetailController" bundle:nil] autorelease];
    exhibitDetailController.managedObjectContext = self.managedObjectContext;
    
    Exhibit *selectedExhibit = [[self fetchedResultsController] objectAtIndexPath:indexPath];
    exhibitDetailController.exhibit = selectedExhibit;
    
    [self.navigationController pushViewController:exhibitDetailController animated:YES];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Exhibit" inManagedObjectContext:self.managedObjectContext];
